...
with(spower,{
  plot(spower$Time,as.numeric(as.character(spower$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
  ...
  plot(spower$Time,as.numeric(as.character(spower$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
dev.off()
